...
public class GuestsController {
    ...
    // BEGIN
    // Создайте в контроллере обработчик, который будет обрабатывать POST-запросы на адрес /guests и
    // регистрировать нового гостя. Если пользователь вводит невалидные данные,
    // должен вернуться код ответа 400 Bad request.
    @PostMapping
