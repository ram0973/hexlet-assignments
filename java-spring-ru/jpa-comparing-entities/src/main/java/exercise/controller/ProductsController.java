...
public class ProductsController {
    ...
    @PostMapping(path = "")
    public ResponseEntity<Product> show(@RequestBody Product product) throws ResourceAlreadyExistsException {
        var maybeProduct =  productRepository.findByPriceAndTitle(product.getPrice(), product.getTitle());
