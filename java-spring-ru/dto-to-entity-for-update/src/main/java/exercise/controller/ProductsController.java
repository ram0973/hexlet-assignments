...
public class ProductsController {
    ...
    // BEGIN
    @PutMapping(path = "/{id}")
    public ProductDTO put(@RequestBody ProductUpdateDTO productData, @PathVariable long id) {
        Product product =  productRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("Product with id " + id + " not found"));
        Product updatedProduct = toUpdatedEntity(productData);
    ...
    private Product toUpdatedEntity(ProductUpdateDTO productDto) {
